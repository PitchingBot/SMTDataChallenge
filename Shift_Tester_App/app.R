  ...
  sidebarLayout(
    ...
    mainPanel(fluidPage(
      ...
      selectInput("batter_hand",
                  ...
                  choices = c("R","L"),
                  selected = "R"),
      sliderInput("batter_ev","Average Batter Exit Velocity", min = 75,max = 95,value = 87),
      ...
      fluidRow(column(width=3,
                      ...
                      sliderInput("transfer_3b","3B Transfer Time",min = 0.5, max = 2,value=1.1,step = 0.1),
                      sliderInput("arm_3b","3B Arm Strength",min = 70, max = 145,value=110,step = 5)#,
               ...
               column(width=3,
                      ...
                      sliderInput("transfer_ss","SS Transfer Time",min = 0.5, max = 2,value=0.9,step = 0.1),
                      sliderInput("arm_ss","SS Arm Strength",min = 70, max = 145,value=105,step = 5)#,
               ...
               column(width=3,
                      ...
                      sliderInput("transfer_2b","2B Transfer Time",min = 0.5, max = 2,value=0.9,step = 0.1),
                      sliderInput("arm_2b","2B Arm Strength",min = 70, max = 145,value=90,step = 5)#,
               ...
               column(width=3,
                      ...
                      sliderInput("transfer_1b","1B Transfer Time",min = 0.5, max = 2,value=1.1,step = 0.1),
                      sliderInput("arm_1b","1B Arm Strength",min = 70, max = 145,value=80,step = 5)#,
